<div class="modal fade" id="unApproveOpManModal" tabindex="-1" role="dialog" aria-labelledby="unapproveSitemanModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <form action="{{ route('inspection.unApprovedByOpManager') }}" method="POST">
                {{ csrf_field() }}
